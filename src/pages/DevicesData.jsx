    ...
    <>
      {loading ? (
        ...
        <section
          ...
          } fixed top-0 left-0 h-screen w-full bg-black/40 backdrop-blur-sm  flex items-center justify-center z-50 `}
        >
          <div className="max-w-6xl mx-auto bg-background dark:bg-gray-900 rounded-lg shadow-lg p-6  overflow-y-auto custom-scrollbar  max-h-[90vh] relative">
            <button
            ...
            >
              ...
              <div>
                ...
                />
                {touched.asset_custodian_name &&
                  errors.asset_custodian_name && (
              ...
              <div>
                ...
                />
                {touched.asset_custodian_contact &&
                  errors.asset_custodian_contact && (
                    <p className="text-red-500 text-sm">
                      {errors.asset_custodian_contact}
                    </p>
                  )}
              ...
              <div>
                ...
                <input
                  ...
                  className="mt-1 w-full p-2 border rounded-md bg-input dark:bg-gray-800 dark:border-gray-700 text-white dark:text-white"
                />
                {touched.cloud_service_provider &&
                  errors.cloud_service_provider && (
                    <p className="text-red-500 text-sm">
                      {errors.cloud_service_provider}
                    </p>
                  )}
              ...
              <div className="md:col-span-2 flex justify-end">
                <button
                  type="submit"
                  className="bg-button hover:scale-105 duration-200 text-white font-medium py-2 px-6 rounded transition"
                >
                  Submit
                </button>
              </div>
