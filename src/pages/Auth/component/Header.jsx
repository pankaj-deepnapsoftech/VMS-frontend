                    ...
                    <div className="relative">
                        ...
                        {activeDropdown === "language" && (
                            <div className="absolute right-0 mt-2 w-24 bg-[#121225] rounded-md shadow-lg py-2 z-10">
                                <button className="block w-full text-left px-4 py-2 hover:bg-[#1e1e3a]">ENG</button>
                                <button className="block w-full text-left px-4 py-2 hover:bg-[#1e1e3a]">ESP</button>
                                <button className="block w-full text-left px-4 py-2 hover:bg-[#1e1e3a]">FRA</button>
                            </div>
                        )}
                    </div>
                    ...
                    <div className="flex flex-col space-y-6">
                        ...
                        <div>
                            ...
                            {activeDropdown === "platform-mobile" && (
                                <div className="mt-2 pl-4 space-y-2">
                                    <Link to="/platform/feature-1" className="block py-2" onClick={closeMenu}>
                                        Feature 1
                                    </Link>
                                    <Link to="/platform/feature-2" className="block py-2" onClick={closeMenu}>
                                        Feature 2
                                    </Link>
                                    <Link to="/platform/feature-3" className="block py-2" onClick={closeMenu}>
                                        Feature 3
                                    </Link>
                                </div>
                            )}
                        ...
                        <div>
                            ...
                            {activeDropdown === "solutions-mobile" && (
                                <div className="mt-2 pl-4 space-y-2">
                                    <Link to="/solutions/solution-1" className="block py-2" onClick={closeMenu}>
                                        Solution 1
                                    </Link>
                                    <Link to="/solutions/solution-2" className="block py-2" onClick={closeMenu}>
                                        Solution 2
                                    </Link>
                                    <Link to="/solutions/solution-3" className="block py-2" onClick={closeMenu}>
                                        Solution 3
                                    </Link>
                                </div>
                            )}
                        ...
                        {/* Regular links */}
                        <Link to="/" className="py-2 border-b border-gray-700 font-medium" onClick={closeMenu}>
                            PRICING
                        </Link>
                        <Link to="/ethical-hackers" className="py-2 border-b border-gray-700 font-medium" onClick={closeMenu}>
                            ETHICAL HACKERS
                        </Link>
                        ...
                        <div>
                            ...
                            {activeDropdown === "company-mobile" && (
                                <div className="mt-2 pl-4 space-y-2">
                                    <Link to="/company/about" className="block py-2" onClick={closeMenu}>
                                        About Us
                                    </Link>
                                    <Link to="/company/team" className="block py-2" onClick={closeMenu}>
                                        Our Team
                                    </Link>
                                    <Link to="/company/careers" className="block py-2" onClick={closeMenu}>
                                        Careers
                                    </Link>
                                </div>
                            )}
