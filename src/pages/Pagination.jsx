  ...
  return (
    <div className="px-6 py-4 border-t border-gray-700 flex items-center justify-between">
      ...
      <div className="flex items-center space-x-2">
        <button
          className={`px-4 text-white py-2 bg-gray-700 hover:bg-gray-600 rounded-lg text-sm ${
        ...
        <button
          className={`px-4 py-2 text-white bg-gray-700 hover:bg-gray-600 rounded-lg text-sm ${
