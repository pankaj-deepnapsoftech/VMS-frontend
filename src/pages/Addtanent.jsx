            ...
            <div className="flex justify-center px-10 ">
                <div className="flex-1 px-8 py-10 rounded-md shadow-md max-w-5xl bg-[#2a282e80]">
                    <form onSubmit={formik.handleSubmit} className="space-y-12">
                        ...
                        <div>
                            <h1 className="text-3xl font-semibold text-white mb-2">Tell Us About Your Enterprise</h1>
                            <p className="text-gray-400 text-sm">
                                Provide details about your company to ensure Enterprise TruRisk Management proactively evaluates and identifies potential cyber security risks and calculates peer benchmarking.
                            </p>
                        </div>
                        ...
                        <div className="grid grid-cols-1 md:grid-cols-2 gap-8">
                            ...
                            <div>
                                ...
                                {formik.touched.Website_url && formik.errors.Website_url && (
                                    <p className="text-red-500 text-xs mt-1">{formik.errors.Website_url}</p>
                                )}
                            </div>

                            <div>
                                <label htmlFor="Employee_count" className="block text-sm font-medium text-gray-300 mb-1">
                                ...
                                {formik.touched.Employee_count && formik.errors.Employee_count && (
                                    <p className="text-red-500 text-xs mt-1">{formik.errors.Employee_count}</p>
                                )}
                            </div>
                            ...
                            <div>
                                ...
                                {formik.touched.Industry && formik.errors.Industry && (
                                    <p className="text-red-500 text-xs mt-1">{formik.errors.Industry}</p>
                                )}
                            </div>
                        </div>
                        ...
                        <div className="pt-10">
                            <h2 className="text-xl font-semibold text-white mb-4">Risk Appetite</h2>
