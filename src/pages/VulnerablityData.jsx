      ...
      {loading ? (
        ...
        <div className="p-4 md:p-6 max-w-[100%] mx-auto bg-gradient-custom ">
          ...
          <div className="mb-4 flex flex-col md:flex-row items-start md:items-center justify-between">
            <div className="lg:flex lg:flex-row grid grid-cols-2 gap-4 mt-5 ml-5  w-full lg:justify-end  lg:items-center py-2 mx-10 lg:gap-2">
              <button
                onClick={() => openModal()}
          ...
          <div className="flex flex-col gap-3 lg:flex-row lg:justify-between  items-center py-3 ">
            <div className="relative mt-4 md:mt-0">
              ...
              <input
               ...
               className="pl-10 pr-4 py-2 border border-gray-400 text-white bg-cards rounded-lg w-full md:w-80"
                value={searchTerm}
              ...
              <table className="min-w-full divide-y divide-gray-700 shadow-sm overflow-hidden">
                ...
                <tbody className="divide-y divide-gray-200">
                  {paginatedData?.map((item) => (
                    <tr
                      key={item._id}
                      className="hover:bg-[#323336] transition h-8"
                    >
                      {" "}
                      {/* Reduced row height */}
                      {/* Checkbox Column */}
