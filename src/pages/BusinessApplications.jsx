                            ...
                            <table className="w-full">
                                <thead>
                                    <tr className="border-b border-slate-700">
                                        ...
                                        <th className="text-left py-4 px-6 font-medium text-gray-300">Country</th>
                                        <th className="text-left py-4 px-6 font-medium text-gray-300">State</th>
                                        <th className="text-left py-4 px-6 font-medium text-gray-300">City</th>
                                        <th className="text-left py-4 px-6 font-medium text-gray-300">Type</th>
                                        <th className="text-left py-4 px-6 font-medium text-gray-300">Application URL</th>
                                ...
                                <tbody>
                                    {filteredTenants.map((tenant) => (
                                        <tr key={tenant.id} className="border-b border-slate-700 hover:bg-slate-750">
                                            ...
                                            <td className="py-4 px-6 text-white">{tenant?.description}</td>
                                            <td className="py-4 px-6 text-white">{tenant?.country}</td>
                                            ...
                                            <td className="py-4 px-6 text-white">{tenant?.applicationUrl}</td>
                                            <td className="py-4 px-6 text-white">{tenant?.modifyCriticality}</td>
                                            <td className="py-4 px-6">
                                                <div className="flex space-x-2">
                                                    <button className="p-1 text-blue-400 hover:text-blue-300">
                                                        <ExternalLink className="w-4 h-4" />
                                                    </button>
                                                    <button onClick={() => DeleteBussinerssApplcation(tenant._id)} className="p-1 text-red-400 hover:text-red-300">
                        ...
                        <div className="p-6">
                            ...
                            <div className="space-y-6">
                                ...
                                <div className="grid md:grid-cols-2 gap-3" >
                                    ...
                                    {/* API Key */}
                                    <div className="space-y-2">
                                        <label className="block text-sm font-medium text-slate-300">Application URL</label>
                                        <input
                                            type="text"
                                            ...
                                            onChange={handleChange}
                                        />
                                        {errors.applicationUrl && touched.applicationUrl && <p className="text-red-400" >{errors.applicationUrl}</p>}
                                    </div>
                                ...
                                <div className="space-y-2">
                                    ...
                                    />
                                    {errors.description && touched.description && <p className="text-red-400" >{errors.description}</p>}
                                </div>
                                ...
                                <div className="grid md:grid-cols-2 gap-3" >
                                    ...
                                    <div className="space-y-2">
                                        ...
                                        <input
                                            ...
                                            onChange={handleChange}
                                        />
                                        {errors.city && touched.city && <p className="text-red-400" >{errors.city}</p>}
                                    </div>
