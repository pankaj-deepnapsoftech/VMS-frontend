        ...
        <div className="fixed inset-0 z-50 text-[#d3d5d8] p-8 transition-opacity duration-300 h-screen w-screen bg-[#111827]">
            ...
            <div className="bg-[#0f172a]  px-10 pb-8 flex justify-between items-center">
                ...
                <div className='flex items-center justify-center' >
                    ...
                    <div className={`${step > 1 ? "bg-blue-500 text-white delay-500" : "bg-white text-black"} h-10 w-10 rounded-full text-2xl  font-bold flex items-center justify-center transition-all duration-200 `} > 2</div>
                </div>
                <button
                    type="button"
                    onClick={handleClose}
            ...
            >
                ...
                <div className="rounded-lg p-4">
                    ...
                    <div className="overflow-x-auto border border-spacing-2 border-[#293550] rounded-xl">
                        {step === 1 ? <RoleConfig values={values} handleChange={handleChange} handleBlur={handleBlur} errors={errors} touched={touched} /> :
                            <RoleTable setFieldValue={setFieldValue} defaultValue={values.allowed_path} />}
                    </div>
                </div>
