...
const ChangePasswordModal = ({ isOpen }) => {
  ...
  return (
    <div className="min-h-full py-20 bg-black/50 flex items-center justify-center p-4 fixed top-0 left-0 w-full">
      <div className="w-full max-w-md">
        <div
          className={`bg-gradient-custom rounded-lg shadow-md overflow-hidden`}
        >
          ...
          <form
            ...
            className="p-6 space-y-6 text-white bg-[#101831]"
          >
